...
public class MainPage_search extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner_area.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                adapter_city=new ArrayAdapter<String>(MainPage_search.this,R.layout.simple1_spinner_item,citys[position]);//通過二維陣列及position的值動態決定下一個選單內容
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(MainPage_search.this, " 您沒有選擇任何項目", Toast.LENGTH_LONG).show();
            }
        });
    ...
    public void onClick(View view){
        Intent intent=new Intent(this,research_menu.class);
